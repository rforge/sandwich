...
%\VignetteDepends{sandwich,pscl,lattice,geepack,multiwayvcov,plm}
...
<<sim,echo=FALSE,results=hide>>=
if(file.exists("sim-CL.rda")) load("sim-CL.rda") else {
...
save(s01, s02, s03, s04, s06, s07, s0607, s08, vc_innov, file = "sim-CL.rda")
}
@
...
sapply(vc_innov, function(x) sqrt(diag(x)))
@
