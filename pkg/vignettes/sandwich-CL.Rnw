...
\Abstract{
  ...
  modified version of \cite{hac:Berger+Graham+Zeileis:2020}, published in the
...
\Address{
  ...
  E-mail: \email{Susanne.Berger@student.uibk.ac.at}, \email{Achim.Zeileis@R-project.org}\\
