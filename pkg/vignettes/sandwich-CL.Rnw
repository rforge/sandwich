...
s03 <- sim(nrep = 10000, nid = 100, nround = 5,
           dist = c("zerotrunc", "zeroinfl", "betareg"), rho = seq(0, 0.9, by = 0.1), xrho = 0.25,
           coef = c(0, 0.85, 0, 0), formula = response ~ x1,
...
are illustrated in the following. \fixme{Unless there is some reason against it: We should probably
rename the `subsample' argument `pairwise' to conform with the pcse package and make it easier to switch.}
