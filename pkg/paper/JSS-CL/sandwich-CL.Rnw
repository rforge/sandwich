...
\new{
\fixme{comprehensive literature review, state-of-the-art methods, Cameron and co-authors \citep{hac:Cameron+Miller:2015}
...
\citep{hac:Nichols+Schaffer:2014} allows to construct the ``meat'' matrix of various
